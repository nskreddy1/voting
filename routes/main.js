...
var transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "naragantisunilkumar2002@gmail.com",
    pass: "yvkvixujacaamnpa",
  },
});
...
router.post("/registerdata", function (req, res) {
  const data = req.body.aadharno; //data stores aadhar no
  console.log(data);
  ...
  conn.query(sql, data, (error, results, fields) => {
    ...
    const is_registered = results[0].Is_registered;
    ...
    if (age < 18) {
      return res.send("You cannot vote as your age is less than 18");
    }
    const mailOptions = {
      from: "naragantisunilkumar2002@gmail.com",
      to: email,
